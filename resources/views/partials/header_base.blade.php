...
<body>
    ...
    <nav class="navbar navbar-expand-lg"
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="/"><img class="w-25 ms-5" src="{!! asset('imagenes/logoEmpresa.png') !!}"
                    alt=""></a>
                    ...
                    <div style="margin-right: 5rem;">
                        ...
                        @auth
                            @if (Auth::guard('proveedor')->check())
                                ...
                                <a href="/perfil_proveedor" class="btn btn-dark">Perfil Proveedor</a>
                                <a href="/lista_carrito" id="btn-nav" class="bi bi-cart ms-4">
                                    <h4 class="d-inline" style="font-weight: lighter;">({{ $total }})</h4>
                                </a>
                            @else
                                <!-- Header para Cliente -->
                                <a href="/perfil" class="btn btn-dark">Perfil</a>
                                <a href="/lista_carrito" id="btn-nav" class="bi bi-cart ms-4">
                                    <h4 class="d-inline" style="font-weight: lighter;">({{ $total }})</h4>
                                </a>
                            @endif
