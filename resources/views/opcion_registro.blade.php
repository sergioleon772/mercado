    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="row text-center">
            ...
            <div class="col-12 col-md-6 mb-4">
                <a href="/registrarse" id="btn-grande" class="btn btn-outline-success w-100 p-5 shadow-lg rounded"
            ...
            <!-- Botón Vendedor -->
            <div class="col-12 col-md-6 mb-4">
                <a href="/registro_proveedor" id="btn-grande" class="btn btn-outline-success w-100 p-5 shadow-lg rounded"
                    style="transition: all 0.3s ease-in-out;">
                    <h2>Proveedor</h2>
