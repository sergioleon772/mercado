...
<h1 class="text-center mt-5 mb-5">Eliminar Comprador</h1>
...
<form class="container" style="width: 30rem;">
    ...
    <!-- Submit button -->
    <a type="button" href="compradores" class="btn btn-outline-primary btn-block mb-4" style="margin-left: 8rem;"">Volver</a>
